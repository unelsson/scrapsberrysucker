...
while 1:
    ...
    if ch=="g":
        ...
        try:
            ...
            print('Error! :)')
        for i in range(0, 19):
            if int(irdistdata[i]) > 0 and int(irdistdata[i]) < 7:
                for k in range(0, irdistdata[i]+1):
                    ...
                    darkenedg = temporaryg - 70
                    darkenedr = temporaryr - 70
                    ...
                    if drawpointerx > 0 and drawpointerx < mapsize and drawpointery > 0 and drawpointery < mapsize:
                        ...
                        if k == irdistdata[i] and irdistdata[i] < 7: map[(drawpointerx, drawpointery)] = [lightenedb,lightenedg,lightenedr]
                    print('debug2')
